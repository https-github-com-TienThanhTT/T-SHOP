...
<div class="content">
              <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                <div class="col">
                  <div class="card h-100 shadow-sm"> <img src="../laptop/gaming/img-gaming/1.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="col">
                  <div class="card h-100 shadow-sm"> <img src="../laptop/gaming/img-gaming/2.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="col">
                  <div class="card h-100 shadow-sm"> <img src="../laptop/gaming/img-gaming/3.webp" class="card-img-top" alt="...">
                ...
                <div class="col">
                  <div class="card h-100 shadow-sm"> <img src="../laptop/gaming/img-gaming/4.webp" class="card-img-top" alt="...">
